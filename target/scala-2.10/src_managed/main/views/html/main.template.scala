...
<div id="page-wrapper">
"""),_display_(Seq[Any](/*81.2*/content)),format.raw/*81.9*/("""
</div>
<!-- /#wrapper --> 
<!-- Bootstrap Core JavaScript --> 
<script src=""""),_display_(Seq[Any](/*85.15*/routes/*85.21*/.Assets.at("javascripts/bootstrap.min.js"))),format.raw/*85.63*/(""""></script>
</body>
</html>
"""))}
    }
