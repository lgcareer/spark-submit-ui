    ...
    <div class="sidebar-nav navbar-collapse">
      <ul class="nav" id="side-menu">
        ...
        <li> <a href="#"><i class="fa fa-table nav_icon"></i>App数据<span class="fa arrow"></span></a>
          <ul class="nav nav-second-level">
            <li> <a href=""""),_display_(Seq[Any](/*68.28*/routes/*68.34*/.YarnList.yarnlist)),format.raw/*68.52*/("""">Yarn数据列表</a> </li>
          </ul>
          <!-- /.nav-second-level --> 
        </li>
      </ul>
...
<div id="page-wrapper">
"""),_display_(Seq[Any](/*79.2*/content)),format.raw/*79.9*/("""
</div>
<!-- /#wrapper --> 
<!-- Bootstrap Core JavaScript --> 
<script src=""""),_display_(Seq[Any](/*83.15*/routes/*83.21*/.Assets.at("javascripts/bootstrap.min.js"))),format.raw/*83.63*/(""""></script>
</body>
</html>
"""))}
    }
