      ...
      <ul class="nav" id="side-menu">
        ...
        <li> <a href="#"><i class="fa fa-check-square-o nav_icon"></i>数据应用面板<span class="fa arrow"></span></a>
          <ul class="nav nav-second-level">
            ...
            <li> <a href=""""),_display_(Seq[Any](/*63.28*/routes/*63.34*/.SparkStream.sparkstream)),format.raw/*63.58*/("""">spark-stream应用</a> </li>
          </ul>
          <!-- /.nav-second-level --> 
        </li>
        <li> <a href="#"><i class="fa fa-table nav_icon"></i>App数据<span class="fa arrow"></span></a>
          <ul class="nav nav-second-level">
            <li> <a href=""""),_display_(Seq[Any](/*69.28*/routes/*69.34*/.YarnList.yarnlist)),format.raw/*69.52*/("""">Yarn数据列表</a> </li>
          </ul>
          <!-- /.nav-second-level --> 
        </li>
      </ul>
...
<div id="page-wrapper">
"""),_display_(Seq[Any](/*80.2*/content)),format.raw/*80.9*/("""
</div>
<!-- /#wrapper --> 
<!-- Bootstrap Core JavaScript --> 
<script src=""""),_display_(Seq[Any](/*84.15*/routes/*84.21*/.Assets.at("javascripts/bootstrap.min.js"))),format.raw/*84.63*/(""""></script>
</body>
</html>
"""))}
    }
