...
<!----End Calender -------->
        ...
        <div class="span_11">
            ...
            <div id = 'worklist' class="col-md-4 stats-info">
                <div class="panel-heading">
                    <h4 class="panel-title"><b>Workers List</b></h4>
                </div>
                <div class="panel-body">
                    <hr>
                    spark://h136159.mars.grid.sina.com.cn:8080<div class="text-success pull-right">ALIVE</div>
    ...
    <script>
         ...
         function cluster_info()"""),format.raw/*334.33*/("""{"""),format.raw/*334.34*/("""
                ...
                dataType:"json",
                 success:function(data)"""),format.raw/*339.40*/("""{"""),format.raw/*339.41*/("""
                  var sparkinfo = eval(data);
                    var alive_workers = sparkinfo.alive_workers;
              ...
              """),format.raw/*357.15*/("""}"""),format.raw/*357.16*/(""");
