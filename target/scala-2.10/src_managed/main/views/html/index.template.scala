        ...
        function task_count()"""),format.raw/*295.30*/("""{"""),format.raw/*295.31*/("""
		 ...
		 var plain_task =0;
			 ...
			 //计算完成的
		      ...
		      if(state == 'ACCEPTED')"""),format.raw/*320.32*/("""{"""),format.raw/*320.33*/("""
                          plain_task += 1;
