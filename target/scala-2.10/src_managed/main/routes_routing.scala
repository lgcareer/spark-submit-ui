...
// @LINE:31
case controllers_Race_TestIndex16(params) => {
   call { 
        invokeHandler(controllers.Race.TestIndex(), HandlerDef(this, "controllers.Race", "TestIndex", Nil,"GET", """TestIndex""", Routes.prefix + """race"""))
   }
}
