...
// @LINE:72
case controllers_HomeController_jobs42(params) => {
   call { 
        invokeHandler(controllers.HomeController.jobs, HandlerDef(this, "controllers.HomeController", "jobs", Nil,"GET", """""", Routes.prefix + """jobs"""))
   }
}
        

// @LINE:73
case controllers_HomeController_streaming43(params) => {
   call { 
        invokeHandler(controllers.HomeController.streaming, HandlerDef(this, "controllers.HomeController", "streaming", Nil,"GET", """""", Routes.prefix + """streaming"""))
   }
}
