...
public static final controllers.ReverseServiceplan Serviceplan = new controllers.ReverseServiceplan();
public static final controllers.ReverseApplication Application = new controllers.ReverseApplication();
public static final controllers.ReverseMonitorController MonitorController = new controllers.ReverseMonitorController();
...
public static final controllers.javascript.ReverseServiceplan Serviceplan = new controllers.javascript.ReverseServiceplan();
public static final controllers.javascript.ReverseApplication Application = new controllers.javascript.ReverseApplication();
public static final controllers.javascript.ReverseMonitorController MonitorController = new controllers.javascript.ReverseMonitorController();
...
public static final controllers.ref.ReverseServiceplan Serviceplan = new controllers.ref.ReverseServiceplan();
public static final controllers.ref.ReverseApplication Application = new controllers.ref.ReverseApplication();
public static final controllers.ref.ReverseMonitorController MonitorController = new controllers.ref.ReverseMonitorController();
